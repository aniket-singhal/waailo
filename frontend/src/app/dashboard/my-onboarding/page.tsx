    ...
    <div className="max-w-3xl space-y-4">
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <Field label="Gender" htmlFor="g">
            <Sel value={form.gender ?? ''} onChange={(v) => set('gender', v)} options={['Male', 'Female', 'Other', 'Prefer not to say']} />
          </Field>
          ...
          <Field label="Marital status" htmlFor="ms">
            <Sel value={form.maritalStatus ?? ''} onChange={(v) => set('maritalStatus', v)} options={['Single', 'Married', 'Divorced', 'Widowed', 'Separated']} />
          </Field>
          <Field label="Nationality" htmlFor="nat">
            <Sel value={form.nationality ?? ''} onChange={(v) => set('nationality', v)} options={['Indian', 'Other']} />
          </Field>
          <Field label="Blood group" htmlFor="bg">
            <Sel value={form.bloodGroup ?? ''} onChange={(v) => set('bloodGroup', v)} options={['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-']} />
          </Field>
